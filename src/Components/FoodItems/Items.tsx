...
const Items:React.FC<{item:Item}>=(props)=> {
    ...
    const removeItemHandler = ()=> dispatch(cartActions.removeItem(props.item.id));
  return (
    // this is a item
    <div className={classes.item}>
        ...
        <div className={classes.priceAndAddToCart}>
            ...
            <ItemAddToCart addItemHandler={addItemHandler} removeItemHandler={removeItemHandler} amount={itemFromCart.items[props.item.id]?itemFromCart.items[props.item.id].amount:0}/>
        </div>
        {/* name */}
